...
ggplot(Data) + geom_sf(aes(fill = Y)) +
  scale_fill_gradient2(
    midpoint = 73, low = "white", high = "blue"
  ) +
  theme_bw()+
  geom_text(
...
signif.X1 = Data$tval.X1 < -2.034515 | Data$tval.X1 > 2.034515
signif.X1

Data$tval.X2 = GWR_sf$X2_TV
signif.X2 = Data$tval.X2 < -2.034515 | Data$tval.X2 > 2.034515
signif.X2

Data$tval.X3 = GWR_sf$X3_TV
signif.X3 = Data$tval.X3 < -2.034515 | Data$tval.X3 > 2.034515
signif.X3

Data$tval.X4 = GWR_sf$X4_TV
signif.X4 = Data$tval.X4 < -2.034515 | Data$tval.X4 > 2.034515
signif.X4

ggplot(Data) + geom_sf(aes(fill = tval.X1)) +
  ...
  geom_text(
    ...
    size = 1.5,
    check_overlap = TRUE
  )+ggtitle("Signifikansi X1 di Jawa Timur")+xlab("Longitude")+ylab("Latitude")

ggplot(Data) + geom_sf(aes(fill = tval.X2)) +
  scale_fill_gradient2(low = "blue", mid = "white", high = "red",midpoint = 0)+
  theme_bw()+
  geom_text(
    aes(label = KAB_KOTA, x = coordinates(as(Data,"Spatial"))[,1], y = coordinates(as(Data,"Spatial"))[,2]),
    ...
    size = 1.5,
    check_overlap = TRUE
  )+ggtitle("Signifikansi X2 di Jawa Timur")+xlab("Longitude")+ylab("Latitude")

ggplot(Data) + geom_sf(aes(fill = tval.X3)) +
  scale_fill_gradient2(low = "blue", mid = "white", high = "red",midpoint = 0)+
  theme_bw()+
  geom_text(
    aes(label = KAB_KOTA, x = coordinates(as(Data,"Spatial"))[,1], y = coordinates(as(Data,"Spatial"))[,2]),
    ...
    size = 1.5,
    check_overlap = TRUE
  )+ggtitle("Signifikansi X3 di Jawa Timur")+xlab("Longitude")+ylab("Latitude")

ggplot(Data) + geom_sf(aes(fill = tval.X4)) +
  scale_fill_gradient2(low = "blue", mid = "white", high = "red",midpoint = 0)+
  theme_bw()+
  geom_text(
    aes(label = KAB_KOTA, x = coordinates(as(Data,"Spatial"))[,1], y = coordinates(as(Data,"Spatial"))[,2]),
    ...
    size = 1.5,
    check_overlap = TRUE
  )+ggtitle("Signifikansi X4 di Jawa Timur")+xlab("Longitude")+ylab("Latitude")
...
signif.lasso.X1 = Data.lasso$tval.X1 < -2.032244509 | Data.lasso$tval.X1 > 2.032244509
signif.lasso.X1

Data.lasso$tval.X3 = GWLASSO_sf$X3_TV
signif.lasso.X3 = Data.lasso$tval.X3 < -2.032244509 | Data.lasso$tval.X3 > 2.032244509
signif.lasso.X3

Data.lasso$tval.X6 = GWLASSO_sf$X6_TV
signif.lasso.X6 = Data.lasso$tval.X6 < -2.032244509 | Data.lasso$tval.X6 > 2.032244509
signif.lasso.X6

ggplot(Data.lasso) + geom_sf(aes(fill = tval.X1)) +
  scale_fill_gradient2(low = "blue", mid = "white", high = "red",midpoint = 0)+
  theme_bw()+
  geom_text(
...
ggplot(Data.lasso) + geom_sf(aes(fill = tval.X3)) +
  scale_fill_gradient2(low = "blue", mid = "white", high = "red",midpoint = 0)+
  theme_bw()+
  geom_text(
    aes(label = KAB_KOTA, x = coordinates(as(Data.lasso,"Spatial"))[,1], y = coordinates(as(Data.lasso,"Spatial"))[,2]),
...
ggplot(Data.lasso) + geom_sf(aes(fill = tval.X6)) +
  scale_fill_gradient2(low = "blue", mid = "white", high = "red",midpoint = 0)+
  theme_bw()+
  geom_text(
    aes(label = KAB_KOTA, x = coordinates(as(Data.lasso,"Spatial"))[,1], y = coordinates(as(Data.lasso,"Spatial"))[,2]),
    ...
    size = 1.5,
    check_overlap = TRUE
  )+ggtitle("Signifikansi X6 di Jawa Timur")+xlab("Longitude")+ylab("Latitude")
...
# Signifikan
Data[(Data$tval.X1 <= -2.034515 | Data$tval.X1 >= 2.034515), "signfikansi_X1"] <- "Signifikan"

# Tidak Signifikan
Data[(Data$tval.X1 > -2.034515 & Data$tval.X1 < 2.034515), "signfikansi_X1"] <- "Tidak Signifikan"
...
# Signifikan
Data[(Data$tval.X2 <= -2.034515 | Data$tval.X2 >= 2.034515), "signfikansi_X2"] <- "Signifikan"

# Tidak Signifikan
Data[(Data$tval.X2 > -2.034515 & Data$tval.X2 < 2.034515), "signfikansi_X2"] <- "Tidak Signifikan"
...
# Signifikan
Data[(Data$tval.X3 <= -2.034515 | Data$tval.X3 >= 2.034515), "signfikansi_X3"] <- "Signifikan"

# Tidak Signifikan
Data[(Data$tval.X3 > -2.034515 & Data$tval.X3 < 2.034515), "signfikansi_X3"] <- "Tidak Signifikan"
...
# Signifikan
Data[(Data$tval.X4 <= -2.034515 | Data$tval.X4 >= 2.034515), "signfikansi_X4"] <- "Signifikan"

# Tidak Signifikan
Data[(Data$tval.X4 > -2.034515 & Data$tval.X4 < 2.034515), "signfikansi_X4"] <- "Tidak Signifikan"
...
#---------------------------------------------------------------#
names(Data) # Check ada di kolom berapa Signifikansi berada
